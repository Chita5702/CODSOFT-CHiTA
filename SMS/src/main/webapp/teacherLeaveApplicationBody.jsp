...
%>
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="sms.controller.TeacherLeaveApplication" method="post">
				...
				<div class="wrap-input100 validate-input" data-validate="Please enter your regdno">
					...
					<input class="input100" type="text" name="regdno" placeholder="Regd No" value="<%= t1.getRegdno()%>" readonly="readonly">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Please enter your email: e@a.x">
					<input class="input100" type="text" name="emailid" placeholder="E-mail" value="<%= t1.getEmailid()%>" readonly="readonly">
					<span class="focus-input100"></span>
				</div>
