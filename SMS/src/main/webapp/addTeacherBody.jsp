                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Add Teacher</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form action="sms.controller.AddTeacher" method="post" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <select name="department" class="form-control">
																		<option value="none" selected="" disabled="">Choose Department</option>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <select name="qualification" class="form-control" placeholder="Qualification">
																		<option value="none" selected="" disabled="">Qualification</option>
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="joindate" type="text" class="form-control" placeholder="Date of Join">
                                                                </div>
