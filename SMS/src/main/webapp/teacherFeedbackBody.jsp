...
%>
	...
	<div class="container-contact100">
		...
		{
		%>
		<h3 style="color: Grey; text-align: center;"><u>
		<%
			out.print(msg);
		}
		%>
		</u></h3>
			<form class="contact100-form validate-form" action="sms.controller.TeacherFeedback" method="post">
				...
				<div class="wrap-input100 validate-input" data-validate = "Please enter email: e@a.x">
					<input class="input100" type="text" name="emailid" placeholder="Email Id" value="<%= s1.getEmailid()%>" readonly="readonly">
					<span class="focus-input100"></span>
				</div>
