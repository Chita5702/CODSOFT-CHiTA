...
<%
		...
		System.out.println(emailid +"0000000000000");
		if(emailid == null)
...
<div class="mainDiv">
	...
	<div class="rightDiv">
		...
		%><%=name1 %>
		<form action="teacherWelcome.jsp">
			<input type="submit" value="back" style="float:right; margin-right:30px;margin-top: -20px;background-color: gray;color: white;">
		</form>
		</div>
		<div id="messageArea">
			
			<iframe src="chatTeacherBox.jsp" id="newPage" height="100%" width="100%"></iframe>
		</div>
		<div id="writeMessage">
		<form action="sms.controller.AddTeacherMessage" method="post">
	...
	<div class="leftDiv">
		...
		<div id="friends">
			...
			ArrayList<Student> all = ChatStudentDao.fetchStudent();
			...
			%>
					...
					<td style="font-size: 25px; padding-top: 10px;text-decoration: none;color: black; padding-left: 20px;"><a href="sms.controller.ChatTeacherPage?name=<%=tr.getName()%>&emailid=<%=tr.getEmailid()%>" style="text-decoration: none; color: black;"><%=tr.getName() %></a></td>
