...
<div class="container1">
   ...
   %><div id="id01" class="modal">
        <form class="modal-content animate" action="ams.controller.UpdateTeacherPhoto" method="post" enctype="multipart/form-data">
