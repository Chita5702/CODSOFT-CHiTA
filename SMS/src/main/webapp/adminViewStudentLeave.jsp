<!DOCTYPE html>
<%@page import="sms.db.StudentLeave"%>
<%@page import="sms.model.StudentLeaveDao"%>
		...
		<div class="wrap-table100">
			<div class="table">
				...
				<div class="row header">
					...
					<div class="cell" style="width: 300px;">Message</div>
					<div class="cell" style="width: 300px;">Status</div>
				</div>
				<%
				...
				<div class="row">
					...
					<div class="cell" data-title="Status">
						...
						%>
						<a
							href="sms.controller.ApproveStudent?emailid=<%=s1.getEmailid()%>&status=1&to=<%=s1.getTo()%>">Approve</a>
						&nbsp;&nbsp; <a
							href="sms.controller.ApproveStudent?emailid=<%=s1.getEmailid()%>&status=0&to=<%=s1.getTo()%>">Reject</a>
						<%
							}
						%>
