            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a class="has-arrow" href="editStudentProfile.jsp" aria-expanded="false"><span class="educate-icon educate-pages icon-wrap"></span> <span class="mini-click-non">Edit Profile</span></a>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="View" href="viewStudentLeave.jsp"><span class="mini-sub-pro">View</span></a></li>
                                <li><a title="Apply" href="studentLeaveApplication.jsp"><span class="mini-sub-pro">Apply</span></a></li>
                                </ul>
                        </li>
                        <!-- <li>
                            <a class="has-arrow" href="viewStudentAttendance.jsp" aria-expanded="false"><span class="educate-icon educate-department icon-wrap"></span> <span class="mini-click-non">Attendance</span></a>
                        ...
                        <li>
                            <a class="has-arrow" href="chat.jsp" aria-expanded="false"><span class="educate-icon educate-message icon-wrap"></span> <span class="mini-click-non">Chatting</span></a>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle interface-mini-nb-dp" aria-expanded="false">
                                <li><a title="Google Map" href="http://bputexam.in/schedule.aspx"><span class="mini-sub-pro">Schedule</span></a></li>
                              <li><a title="Google Map" href="http://bputexam.in/studentsection/resultpublished/studentresult.aspx"><span class="mini-sub-pro">Result</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="viewTeacher.jsp" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap"></span> <span class="mini-click-non">View Teacher</span></a>
                        </li>
                         
                        <li>
                            <a class="has-arrow" href="studentFeedback.jsp" aria-expanded="false"><span class="educate-icon educate-apps icon-wrap"></span> <span class="mini-click-non">Feedback</span></a>
                                    ...
                                    <div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="studentWelcome.jsp" class="nav-link">Home</a>
                                                </li>
   ...
   %>
  							...
  							%>
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li><a href="studentViewProfile.jsp"><span class="edu-icon edu-user-rounded author-log-ic"></span>My Profile</a>
                                                        </li>
                                                        <li><a href="studentChangePassword.jsp"><span class="edu-icon edu-settings author-log-ic"></span>Change Password</a>
                                                        </li>
                                                        <li><a href="sms.controller.StudentLogout"><span class="edu-icon edu-locked author-log-ic"></span>Log Out</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
