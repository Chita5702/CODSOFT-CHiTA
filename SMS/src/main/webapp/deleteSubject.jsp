		...
		<div class="wrap-table100">
			<div class="table">
				...
				<div class="row header">
					...
					<div class="cell" style="width: 130px;">Branch</div>
					<div class="cell" style="width: 130px;">Delete</div>
				</div>
				<%
				...
				<div class="row">
					...
					<div class="cell" data-title="Location">
						<a
							href="sms.controller.DeleteSubject?subjectid=<%=s1.getSubjectid()%>">Delete</a>
					</div>
