<!DOCTYPE html>
<%@page import="sms.model.TeacherLeaveDao"%>
<%@page import="sms.db.TeacherLeave"%>
			...
			<div class="table">
				...
				<div class="row">
					...
					<div class="cell" data-title="Status">
						...
						%>
						<a
							href="sms.controller.ApproveTeacher?emailid=<%=t1.getEmailid()%>&status=1&to=<%=t1.getTo()%>">Approve</a>
						&nbsp;&nbsp; <a
							href="sms.controller.ApproveTeacher?emailid=<%=t1.getEmailid()%>&status=0&to=<%=t1.getTo()%>">Reject</a>
						<%
							}
						%>
